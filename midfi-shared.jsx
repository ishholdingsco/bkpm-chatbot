...
function Logo({ size = 18, showTag = true, mono = false }) {
...
// Slots:
//   left:    rendered after the Logo (e.g. back button, breadcrumb)
//   center:  rendered in the middle (page-name pill, etc.) — optional
//   right:   rendered before the org meta (e.g. presence ribbon, status chip)
//   org:     small meta line on the far right; defaults to DATA.org.name
function TopBar({ left, center, right, org, showLogo = true, logoSize = 18, showOrg = true }) {
  return (
    <div style={{
      height: 48,
...
Object.assign(window, { DATA, KIND_COLOR, Avatar, AvatarStack, Logo, BKPM, Cite, ArtifactCard, TopBar });
