...
function EmptyState() {
  ...
  return (
    <div className="frame col" style={{ background: 'var(--surface)' }}>
      <TopBar
        right={<span className="mono" style={{ fontSize: 11, color: 'var(--ink-3)' }}>new project</span>}
      />
...
function NotificationsDigest() {
  ...
  return (
    <div className="frame col" style={{ background: 'var(--surface)' }}>
      <TopBar
        right={<span className="mono" style={{ fontSize: 11, color: 'var(--ink-3)' }}>{DATA.user.name}</span>}
        showOrg={false}
      />
